...
lang: es
abstract: |
 Este proyecto explora la clasificación automática de relatos paranormales extraídos mediante web scraping de Your Ghost Stories. Se procesó el texto aplicando técnicas básicas de NLP y se representó en una matriz de términos. Se evaluó el desempeño de distintos modelos Naïve Bayes (ajustes de Laplace y Poisson) en escenarios multiclase y binarios. Los resultados revelan la importancia de abordar el desbalance y la dimensionalidad para mejorar la clasificación automática de textos en este tipo de corpus.
...
![Palabras más frecuentes en relatos](palabras_frecuentes.png){width="60%" height="250px" fig-align="center"}
...
![Top 10 palabras más frecuentes por categoría.Cada panel muestra las 10 palabras más repetidas en los relatos correspondientes a cada categoría temática.](top_palabras_por_categoria.png){width="70%" fig-align="center"}
...
![Emociones más frecuentes en relatos paranormales.Cada panel muestra las cinco emociones más mencionadas dentro de cada categoría de relatos, destacando la prevalencia de sentimientos negativos como miedo y tristeza, junto con otros como sorpresa o anticipación.](sentimientos_por_categoria.png){width="60%" height="250px" fig-align="center""}
...
![Distribución de puntajes AFINN en relatos paranormales.La mayoría de los relatos presentan un puntaje cercano a cero, lo que refleja una tendencia hacia la neutralidad, aunque también aparecen relatos con cargas emocionales más negativas o positivas.](distribucion_afinn.png){width="60%" height="250px" fig-align="center"}
...
## Entrenamiento de clasificador naïve Bayes
...
## Dicotimización en eventos de las variables
...
## Implementación de la distribución Poisson
...
Los resultados del proyecto muestran que el clasificador Naïve Bayes, aplicado en este caso a relatos paranormales, presenta un rendimiento limitado en escenarios de multiclase debido a su alta dimensionalidad y el desbalance de categorías (lo cual ya se observó previamente que dirige a un sesgo). De igual forma, la simplificación binaria ("Haunted Places" vs "Other") mejora la exactitud global, pero mantiene baja sensibilidad hacia la clase minoritaria, y tiende a ser un modelo que se ajusta más a clasificar en la categoría de "Other". Asimismo, ajustes como la distribución de Poisson y el suavizamiento de Laplace aportan mejoras en los clasificadores, confirmando la importancia de una correcta selección de parámetros, pues eran notorios los cambios en los resultados cuando estos variaban. En conclusión, la aplicación de los distintos modelos demuestra tanto la utilidad del enfoque probabilístico, así como sus limitaciones ante diversos escenarios y las bases datos, al igual que abre la puerta a futuras investigaciones que incorporen técnicas de re-muestreo y modelos más complejos para abordar el sesgo y los errores de clasificación en textos extensos y desbalanceados.
